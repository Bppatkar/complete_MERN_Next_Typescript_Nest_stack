    ...
    <header className="sticky inset-x-0 top-0 z-50 w-full border-b bg-[#121212] px-4">
      ...
      <nav className="mx-auto flex max-w-7xl items-center py-2">
        ...
        <div>
          ...
          {isOpen && (
            <div
              className={`fixed inset-y-0 right-0 flex w-full max-w-xs shrink-0 flex-col border-l border-white bg-[#121212] transition-transform translate-x-0 sm:static sm:ml-4 sm:w-auto sm:border-none`}
            >
